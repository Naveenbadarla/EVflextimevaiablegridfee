...
st.markdown("<div style='text-align:center; font-family:Segoe UI, Helvetica, sans-serif; font-size:20px; color:#7A7A7A; margin-top:-10px;'>Where optimization meets opportunity — powered by AI</div>", unsafe_allow_html=True)
